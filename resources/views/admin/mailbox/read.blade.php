...
<div class="row">
	<div class="col-md-3">
		<a href="{{ route('mailbox.compose') }}" class="btn btn-primary btn-block margin-bottom ajax_anchor">Compose</a>
		<div class="box box-solid">
			...
			<div class="box-body no-padding">
				<ul class="nav nav-pills nav-stacked">
					<li><a href="{{ route('mailbox.index') }}" class="ajax_anchor"><i class="fa fa-inbox"></i> Inbox<span class="label label-primary pull-right">12</span></a></li>
					<li><a href="#"><i class="fa fa-envelope"></i> Sent</a></li>
					<li><a href="#"><i class="fa fa-file-alt"></i> Drafts</a></li>
		...
		<div class="box box-solid">
			...
			<div class="box-body no-padding">
				<ul class="nav nav-pills nav-stacked">
					<li><a href="#"><i class="far fa-fw fa-circle text-red"></i> Important</a></li>
					<li><a href="#"><i class="far fa-fw fa-circle text-yellow"></i> Promotions</a></li>
					<li><a href="#"><i class="far fa-fw fa-circle text-light-blue"></i> Social</a></li>
				</ul>
			</div>
			<!-- /.box-body -->
		</div>
		...
		<div class="box box-primary">
			...
			<div class="box-body no-padding">
				...
				<div class="mailbox-controls with-border text-center">
					<div class="btn-group">
						<button type="button" class="btn btn-default btn-sm" data-toggle="tooltip" data-container="body" title="Delete"><i class="fa fa-trash"></i></button>
			...
			<div class="box-footer">
				<ul class="mailbox-attachments clearfix">
					...
					<li>
						<span class="mailbox-attachment-icon"><i class="fa fa-file-word"></i></span>
						<div class="mailbox-attachment-info">
